...
|----|--------|------|--------|-------------|--------|-------------------|
| S25.T1 | Estudar formato Domínio Sistemas | Backend | 5 | Backend | ⬜ | Formato compreendido |
| S25.T2 | Implementar exportação Domínio | Backend | 8 | Backend | ⬜ | Arquivo gerado |
| S25.T3 | Estudar formato Fortes | Backend | 5 | Backend | ⬜ | Formato compreendido |
...
| ID | Tarefa | Tipo | Pontos | Responsável | Status | Critério de Aceite |
|----|--------|------|--------|-------------|--------|-------------------|
| S26.T1 | Registrar New Holland Developer | DevOps | 3 | DevOps | ⬜ | Registro aprovado |
| S26.T2 | Integrar PLM Connect API | Backend | 13 | Backend | ⬜ | API conectada |
| S26.T3 | Buscar dados de máquinas NH | Backend | 8 | Backend | ⬜ | Dados obtidos |
| S26.T4 | Criar modelo Integração | Backend | 3 | Backend | ⬜ | Migration criada |
| S26.T5 | Criar marketplace (catálogo) | Frontend | 13 | Frontend | ⬜ | Catálogo visível |
| S26.T6 | Frontend: Instalar integração | Frontend | 8 | Frontend | ⬜ | Instalação funcional |
| S26.T7 | Frontend: Gerenciar integrações | Frontend | 8 | Frontend | ⬜ | Gestão funcional |
| S26.T8 | Backend: Webhook de integrações | Backend | 8 | Backend | ⬜ | Webhook funcionando |
...
| ID | Tarefa | Tipo | Pontos | Responsável | Status | Critério de Aceite |
|----|--------|------|--------|-------------|--------|-------------------|
| S27.T1 | Estudar padrão Verra | Backend | 5 | Backend | ⬜ | Padrão compreendido |
| S27.T2 | Estudar padrão Gold Standard | Backend | 5 | Backend | ⬜ | Padrão compreendido |
| S27.T3 | Criar modelo ProjetoCarbono | Backend | 3 | Backend | ⬜ | Migration criada |
| S27.T4 | Implementar MRV (Monitoramento) | Backend | 13 | Backend | ⬜ | Monitoramento ativo |
| S27.T5 | Implementar MRV (Reporte) | Backend | 8 | Backend | ⬜ | Relatório gerado |
| S27.T6 | Implementar MRV (Verificação) | Backend | 8 | Backend | ⬜ | Verificação pronta |
| S27.T7 | Calcular créditos de carbono | Backend | 8 | Backend | ⬜ | Créditos calculados |
| S27.T8 | Frontend: Cadastrar projeto | Frontend | 8 | Frontend | ⬜ | Cadastro funcional |
| S27.T9 | Frontend: Dashboard MRV | Frontend | 8 | Frontend | ⬜ | Dashboard completo |
| S27.T10 | Frontend: Vender créditos | Frontend | 5 | Frontend | ⬜ | Venda funcional |
| S27.T11 | Testes MRV | QA | 5 | QA | ⬜ | Testes aprovados |

**Definição de Pronto:**
- [ ] MRV implementado
- [ ] Créditos de carbono calculados
- [ ] Dashboard de projeto no ar
...
- [ ] Piscicultura implementada
- [ ] Tanques-rede gerenciados
...
| ID | Tarefa | Tipo | Pontos | Responsável | Status | Critério de Aceite |
|----|--------|------|--------|-------------|--------|-------------------|
| S29.T1 | Criar modelo ConfinamentoLote | Backend | 3 | Backend | ⬜ | Migration criada |
| S29.T2 | Confinamento: Entrada de lotes | Backend | 5 | Backend | ⬜ | Entrada registrada |
| S29.T3 | Confinamento: Peso diário | Backend | 5 | Backend | ⬜ | Peso registrado |
| S29.T4 | Confinamento: Ganho médio diário | Backend | 5 | Backend | ⬜ | GMD calculado |
| S29.T5 | Confinamento: Conversão alimentar | Backend | 5 | Backend | ⬜ | CA calculada |
| S29.T6 | Criar modelo RacaoTMR | Backend | 3 | Backend | ⬜ | Migration criada |
| S29.T7 | Confinamento: Fórmula de ração | Backend | 8 | Backend | ⬜ | Fórmula criada |
| S29.T8 | Confinamento: Controle de cochos | Backend | 8 | Backend | ⬜ | Cochos controlados |
| S29.T9 | Confinamento: Projeção de abate | Backend | 5 | Backend | ⬜ | Projeção calculada |
| S29.T10 | Leite: Qualidade avançada | Backend | 5 | Backend | ⬜ | Qualidade registrada |
| S29.T11 | Leite: Curva de lactação | Backend | 8 | Backend | ⬜ | Curva gerada |
| S29.T12 | Frontend: Gestão confinamento | Frontend | 8 | Frontend | ⬜ | Gestão completa |
| S29.T13 | Frontend: Gestão leite | Frontend | 8 | Frontend | ⬜ | Gestão completa |
| S29.T14 | Testes confinamento e leite | QA | 5 | QA | ⬜ | Testes aprovados |

**Definição de Pronto:**
- [ ] Confinamento implementado
- [ ] TMR (ração) formulada
- [ ] Projeção de abate calculada
- [ ] Curva de lactação gerada
...
| ID | Tarefa | Tipo | Pontos | Responsável | Status | Critério de Aceite |
|----|--------|------|--------|-------------|--------|-------------------|
| S30.T1 | Criar modelo Raca | Backend | 3 | Backend | ⬜ | Migration criada |
| S30.T2 | Cadastrar raças com padrões | Backend | 5 | Backend | ⬜ | Raças cadastradas |
| S30.T3 | Implementar DEPs (cálculo) | Backend | 13 | Backend | ⬜ | DEPs calculados |
| S30.T4 | Comparação com padrão genético | Backend | 8 | Backend | ⬜ | Comparação gerada |
| S30.T5 | Sugestão de acasalamentos | Backend | 8 | Backend | ⬜ | Sugestões geradas |
| S30.T6 | Criar modelo Treinamento | RH | 3 | Backend | ⬜ | Migration criada |
| S30.T7 | Catálogo de treinamentos | RH | 5 | Backend | ⬜ | Catálogo criado |
| S30.T8 | Atribuir treinamentos | RH | 5 | Backend | ⬜ | Atribuição funcional |
| S30.T9 | Acompanhamento de conclusão | RH | 5 | Backend | ⬜ | Conclusão registrada |
| S30.T10 | Gerar certificados | RH | 5 | Backend | ⬜ | Certificados gerados |
| S30.T11 | Frontend: Gestão genética | Frontend | 8 | Frontend | ⬜ | Gestão completa |
| S30.T12 | Frontend: Plataforma treinamentos | Frontend | 8 | Frontend | ⬜ | Plataforma no ar |
| S30.T13 | Testes genética e treinamentos | QA | 5 | QA | ⬜ | Testes aprovados |

**Definição de Pronto:**
- [ ] DEPs calculados
- [ ] Sugestão de acasalamentos
- [ ] Plataforma de treinamentos no ar
...
| ID | Tarefa | Tipo | Pontos | Responsável | Status | Critério de Aceite |
|----|--------|------|--------|-------------|--------|-------------------|
| S31.T1 | Criar modelo ContratoFuturo | Backend | 3 | Backend | ⬜ | Migration criada |
| S31.T2 | Cadastrar contratos (B3) | Backend | 5 | Backend | ⬜ | Contratos cadastrados |
| S31.T3 | Implementar hedge de preço | Backend | 8 | Backend | ⬜ | Hedge registrado |
| S31.T4 | Implementar barter (troca) | Backend | 8 | Backend | ⬜ | Barter registrado |
...
| ID | Tarefa | Tipo | Pontos | Responsável | Status | Critério de Aceite |
|----|--------|------|--------|-------------|--------|-------------------|
| S32.T1 | Configurar MQTT broker | IoT | 5 | IoT | ⬜ | Broker configurado |
| S32.T2 | Integrar sensores de temperatura | IoT | 8 | IoT | ⬜ | Sensores conectados |
| S32.T3 | Integrar sensores de umidade | IoT | 8 | IoT | ⬜ | Sensores conectados |
| S32.T4 | Integrar balanças inteligentes | IoT | 8 | IoT | ⬜ | Balanças conectadas |
| S32.T5 | Integrar silos automatizados | IoT | 8 | IoT | ⬜ | Silos conectados |
| S32.T6 | Alertas de ambiência (estresse) | Backend | 5 | Backend | ⬜ | Alertas gerados |
| S32.T7 | Leitura automática de peso | IoT | 5 | IoT | ⬜ | Peso lido |
| S32.T8 | Nível de silos em tempo real | IoT | 5 | IoT | ⬜ | Nível lido |
| S32.T9 | Frontend: Dashboard IoT | Frontend | 8 | Frontend | ⬜ | Dashboard completo |
| S32.T10 | Frontend: Configurar sensores | Frontend | 5 | Frontend | ⬜ | Configuração funcional |
| S32.T11 | Testes de sensores | QA | 5 | QA | ⬜ | Testes aprovados |

**Definição de Pronto:**
- [ ] Sensores de temperatura/umidade
- [ ] Balanças inteligentes integradas
- [ ] Silos automatizados
...
| ID | Tarefa | Tipo | Pontos | Responsável | Status | Critério de Aceite |
|----|--------|------|--------|-------------|--------|-------------------|
| S33.T1 | Criar modelo ILPF | Backend | 3 | Backend | ⬜ | Migration criada |
| S33.T2 | ILPF: Rotação cultura/pastagem | Backend | 8 | Backend | ⬜ | Rotação registrada |
| S33.T3 | ILPF: Crédito de carbono | Backend | 5 | Backend | ⬜ | Crédito calculado |
| S33.T4 | ILPF: Integração com módulos | Backend | 5 | Backend | ⬜ | Integração funcional |
| S33.T5 | App: Login colaboradores | Mobile | 5 | Mobile | ⬜ | Login funcional |
| S33.T6 | App: Registrar horas trabalhadas | Mobile | 8 | Mobile | ⬜ | Horas registradas |
| S33.T7 | App: Registrar produção | Mobile | 8 | Mobile | ⬜ | Produção registrada |
| S33.T8 | App: Ver contracheque | Mobile | 5 | Mobile | ⬜ | Contracheque visível |
| S33.T9 | App: Receber treinamentos | Mobile | 5 | Mobile | ⬜ | Treinamentos visíveis |
| S33.T10 | Backend: Aprovar apontamentos | Backend | 5 | Backend | ⬜ | Aprovação funcional |
| S33.T11 | Frontend: Gestão ILPF | Frontend | 8 | Frontend | ⬜ | Gestão completa |
| S33.T12 | Testes ILPF e app | QA | 5 | QA | ⬜ | Testes aprovados |

**Definição de Pronto:**
- [ ] ILPF implementado
- [ ] App colaboradores publicado
- [ ] Apontamentos de horas
- [ ] Contracheque visível no app

---

## 📅 Sprint 34 (Semana 67-68)
**Tema:** Estabilização Fase 3
**Objetivo:** Bug fixes, performance e preparação Fase 4

### Tarefas

| ID | Tarefa | Tipo | Pontos | Responsável | Status | Critério de Aceite |
|----|--------|------|--------|-------------|--------|-------------------|
| S34.T1 | Corrigir bugs MRV/Carbono | Backend | 8 | Backend | ⬜ | Bugs resolvidos |
| S34.T2 | Corrigir bugs IoT | IoT | 8 | IoT | ⬜ | Bugs resolvidos |
| S34.T3 | Otimizar cálculos DEPs | Backend | 8 | Backend | ⬜ | Cálculo < 1s |
