...
Uma conta representa um produtor rural — pessoa física ou jurídica. É a
...
- Em quais propriedades essa pessoa terá acesso (pode ser em todas ou em
...
Um usuário convidado recebe uma notificação e deve aceitar o convite para
ter acesso liberado. Enquanto o convite estiver pendente, o usuário não
acessa a conta.
...
**Conta suspensa:** usuários de uma conta suspensa não acessam as
