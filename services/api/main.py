...
from imoveis.routers import imovel as imoveis_router
...
app.include_router(imoveis_router.router, prefix="/api/v1")
...
from agricola.talhoes.router import router as router_talhoes
...
from pessoas.router import router as router_pessoas
...
from pecuaria.routers import piquetes as pecuaria_piquetes
...
app.include_router(router_talhoes, prefix="/api/v1")
...
app.include_router(pecuaria_piquetes.router, prefix="/api/v1")
